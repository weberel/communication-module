...
| Cellular upload (`ModemA7672` HTTP) | ⚠️ unrun | The one major path never proven with this driver -- bench attempts ended "no SIM / no network" (SIM presence unverified at the time). |
